...
Ce fruit permet de "prevenir certaines maladies graves."
 ...
 \begin{itemize}
    \item Prévenir les problèmes cardiaques
    \item Réduire les quantités de cholestérol
    \item Améliorer les processus digestifs
    \item Renforcer l'immunité
    \item Haut en antioxydants
    \item Aider à la maintenance de peau saine
    \item Réduire la chance de développer le diabète
    \item Renforcer la santé et la capacité mémorielle cérébrale
  \end{itemize}
...
thius is so amazing and it never 


beneficial for heart health. improves digestion. rich in antioxidants. boosts immune system. lowers cholesterol levels.
