...
def bind_global_shortcuts(root):
    ...
    simple_shortcuts = {
        ...
        "<Control-Shift-G>": (llm_service.open_generate_text_panel, "LLM Generate Panel"),
        "<Control-Shift-C>": (llm_service.request_llm_to_complete_text, "LLM Complete"),
        "<Control-Shift-K>": (llm_service.open_set_keywords_panel, "Set LLM Keywords"),
        "<Control-Shift-P>": (llm_service.open_proofreading_panel, "Proofread Document"),
        "<Control-Shift-E>": (llm_service.open_edit_prompts_panel, "Edit LLM Prompts"),
        "<Control-Shift-S>": (llm_service.start_autostyle_process, "Smart Style"),
        "<Control-r>": (llm_rephrase.open_rephrase_panel, "Rephrase Panel"),
